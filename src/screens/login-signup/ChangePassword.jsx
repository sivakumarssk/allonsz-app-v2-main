...
import { forgot_OTP } from "../../Network/ApiCalling";
...
const ChangePassword = () => {
  ...
  const onSubmit = async (values) => {
    ...
    try {
      setLoading(true);
      const res = await forgot_OTP(formData);
      ...
      >
        ...
        >
          ...
          <View className="w-[90%] mx-auto justify-center mt-[130px] mb-[40px]">
            <Text className="font-montmedium font-bold text-[34px] leading-[36px] tracking-wider text-bigText w-[60%] pt-1">
              Change New Password
            </Text>
          </View>
          <View className="w-[88%] mx-auto ">
            <PrimaryInput
              label={"Email Id"}
